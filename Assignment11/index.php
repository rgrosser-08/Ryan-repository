  ...
  <div class="container">
    ...
    ?>
        <div class="jumbotron">
            ...
            <a class="btn btn-primary btn-lg" href="standard/create.php" role="button">Click to create</a>
        </div>

    
    <?php
      echo '<a href="standard">Your Posts</a>';
      echo '&nbsp;&nbsp;<a href="admin/admin.php">Admin Page</a>';
      echo '&nbsp;&nbsp;<a href="manager">Manager Page</a>&nbsp;';    
    }
    ?>

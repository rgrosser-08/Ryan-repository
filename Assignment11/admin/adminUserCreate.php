...
Role. Enter "a" for admin, "s" for standard, and "m" for manager.
...
if(!empty($_POST)){
  $_POST['password']=password_hash($_POST['password'], PASSWORD_DEFAULT);
	...
	$q=$db->prepare('INSERT INTO users(email,password,role) VALUES(?,?,?)');
	$q->execute([$_POST['email'],$_POST['password'],$_POST['role']]);
